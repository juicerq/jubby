...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            plugins::tasks::commands::tasks_auto_tag,
            plugins::tasks::commands::subtasks_create,
            plugins::tasks::commands::subtasks_toggle,
            plugins::tasks::commands::subtasks_delete,
            plugins::tasks::commands::subtasks_reorder,
            plugins::tasks::commands::subtasks_update_text,
            plugins::tasks::commands::subtasks_update_status,
            plugins::tasks::commands::subtasks_update_order,
            plugins::tasks::commands::subtasks_update_category,
            plugins::tasks::commands::subtasks_update_notes,
            plugins::tasks::commands::subtasks_update_should_commit,
            plugins::tasks::commands::tasks_update_description,
            plugins::tasks::commands::tasks_update_working_directory,
            plugins::tasks::commands::steps_create,
            plugins::tasks::commands::steps_toggle,
