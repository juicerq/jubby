...
// ============================================================================
// DEPRECATED: Old single-server state kept for backward compatibility during
// migration. Will be removed after all code is updated to use OpenCodeServersState.
// ============================================================================

#[deprecated(note = "Use OpenCodeServersState for per-directory server management")]
