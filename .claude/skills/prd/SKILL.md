...
- **shouldCommit:** Boolean. Use `true` ONLY for code that will go to production. Use `false` for exploratory work, investigations, POCs, or any task whose output won't be merged/deployed.
